$(function () {
	...
	$('.icon_kabinet').click(function () {
		$('.kabinet_log_wrap').fadeToggle();
		$('.icon_kabinet').toggleClass('active');
	})
	$('.icon_search').click(function () {
		$(' .top_line_mnu_right li .input_holder input[type=search]').fadeToggle();
	})
	$('.get_one_click a, .calback_form').click(function () {
		$('#get_one_click').fadeToggle();
	});
...
$(document).ready(function () {
	...
	$('.close_icon_mnu').click(function(){
		if($('.nav_header nav').hasClass('ssm-nav-visible')) {
			$('.nav_header nav').removeClass("ssm-nav-visible");
			$('.nav_header nav').css("transform","translate(-280px,0)");
		}
